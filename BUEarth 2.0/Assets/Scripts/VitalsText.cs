...
public class VitalsText : MonoBehaviour {
    ...
    public void UpdateText()
    {
        ...
        AddToList("H2O", "Gas Pressure", DataController.data.data[0].rate_o2.ToString(), tempFillAmount, tempPriority, false);
        ...
        AddToList("SOP", "Current Pressure", DataController.data.data[0].rate_o2.ToString(), tempFillAmount, tempPriority, false);
